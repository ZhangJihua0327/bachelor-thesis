...
\end{align}
其中$Init$ 表示初始状态，$Next$ 表示状态转移，$Safety$ 是安全属性，$Ind$ 表达的是归纳不变式，
...
也就是说如果能证明$Ind$的正确性，也就能证明$Safety$的正确性。
这是归纳不变式所必须满足的三个条件。
